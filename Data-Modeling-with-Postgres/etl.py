...
def process_song_file(cur, filepath):
    """Process song file. Inserts artists and songs data into their tables.
    ...
    for value in df.values:
        _, artist_id, artist_latitude, artist_longitude, artist_location, artist_name, song_id, title, duration, year = value
...
def process_log_file(cur, filepath):
    ...
    Args:
        cur: cursor reference
        filepat: complete file path for the file to load
    """
    # open log file
...
def process_data(cur, conn, filepath, func):
    ...
    Args:
        cur ([type]): a database cursor reference
        conn ([type]): database connection reference
        filepath ([type]): parent directory where the files exists
        func ([type]): function to call
    """
